      ...
      <div className="container mx-auto flex justify-between items-center px-4">
        <Link href="/bn" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold font-headline text-primary">
                ফ্রিডাঙ্কক্যালকুলেটর.কম
            </span>
        </Link>
        <div className="flex items-center gap-2">
            <nav className="hidden md:flex gap-1">
            <Button variant="ghost" asChild>
                <Link href="/bn#how-it-works">এটি কিভাবে কাজ করে</Link>
            </Button>
            <Button variant="ghost" asChild>
            ...
            <Button variant="ghost" asChild>
                <Link href="/bn#about">আমাদের সম্পর্কে</Link>
            </Button>
            <Button variant="ghost" asChild>
                <Link href="/bn#contact">যোগাযোগ করুন</Link>
            </Button>
            </nav>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="icon">
                  ...
                  <span className="sr-only">ভাষা পছন্দ করুন</span>
                </Button>
              </DropdownMenuTrigger>
