    ...
    <header className="py-4 border-b sticky top-0 bg-background/95 backdrop-blur-sm z-10">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" asChild>
                <Link href="/ur#about">ہمارے بارے میں</Link>
            </Button>
            <Button variant="ghost" asChild>
                <Link href="/ur#contact">رابطہ کریں</Link>
            </Button>
            </nav>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="icon">
                  ...
                  <span className="sr-only">زبان کا انتخاب کریں</span>
                </Button>
              </DropdownMenuTrigger>
