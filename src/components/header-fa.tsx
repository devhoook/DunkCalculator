  ...
  return (
    <header className="py-4 border-b sticky top-0 bg-background/95 backdrop-blur-sm z-10">
      <div className="container mx-auto flex justify-between items-center px-4">
        <Link href="/fa" className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" asChild>
                <Link href="/fa#how-it-works">چگونه کار می کند</Link>
            </Button>
            <Button variant="ghost" asChild>
                <Link href="/fa#calculator">ماشین حساب</Link>
            </Button>
            <Button variant="ghost" asChild>
                <Link href="/fa#article">مقاله</Link>
            </Button>
            <Button variant="ghost" asChild>
                <Link href="/fa#faq">سوالات متداول</Link>
            </Button>
            <Button variant="ghost" asChild>
                <Link href="/fa#about">درباره</Link>
            </Button>
            <Button variant="ghost" asChild>
                <Link href="/fa#contact">تماس</Link>
            </Button>
            </nav>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="icon">
                  ...
                  <span className="sr-only">انتخاب زبان</span>
                </Button>
              </DropdownMenuTrigger>
