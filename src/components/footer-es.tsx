        ...
        <footer className="bg-muted text-muted-foreground border-t">
            <div className="container mx-auto py-8 px-4">
                <div className="flex justify-center items-center gap-4 flex-wrap mb-4">
                    ...
                    <Link href="/terms-of-service" className="hover:text-primary transition-colors">Términos de Servicio</Link>
                ...
                <div className="text-center text-sm">
                    <p>&copy; {new Date().getFullYear()} CalculadoraDeMates.com. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>
    );
